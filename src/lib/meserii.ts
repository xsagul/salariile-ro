...
export const MESERII: Meserie[] = [
  ...
  { slug: "devops-engineer", nume: "Inginer DevOps", de: "inginer DevOps", categorie: "it", caen3: "62", caen2: "62-63", isco: "specialisti",
  ...
  { slug: "administrator-sistem", nume: "Administrator de sistem", de: "administrator de sistem", categorie: "it", caen3: "62", caen2: "62-63", isco: "specialisti",
    ceFace: "Ține în funcțiune serverele, rețeaua și conturile dintr-o organizație și răspunde de backup și securitate." },
  { slug: "analist-date", nume: "Analist de date", de: "analist de date", categorie: "it", caen3: "63", caen2: "62-63", isco: "specialisti",
    ceFace: "Transformă date brute în rapoarte și modele pe care se iau decizii de business." },
  { slug: "inginer-telecomunicatii", nume: "Inginer telecomunicații", de: "inginer telecomunicații", categorie: "it", caen3: "61", caen2: "61", isco: "specialisti", cor: "215204",
  ...
  { slug: "medic-rezident", nume: "Medic rezident", de: "medic rezident", categorie: "medical", caen3: "86", caen2: "Q", isco: "specialisti", cor: "221102",
    ceFace: "Efectuează pregătirea clinică de specialitate într-o unitate sanitară acreditată, acordând asistență medicală pacienților sub îndrumarea medicilor specialiști și primari.",
    nota: "Salariul de bază al medicului rezident este stabilit prin grilă legală (Anexa II din Legea 153/2017) pe anii I–VII (7.125–8.875 lei brut), la care se adaugă sporul de secție (15%–85%) și plata gărzilor." },
  ...
  { slug: "registrator-medical", nume: "Registrator medical", de: "registrator medical", categorie: "medical", caen3: "86", caen2: "Q", isco: "functionari", cor: "422207",
    ceFace: "Înregistrează pacienții, programările și documentele medicale într-o unitate sanitară." },
  ...
  { slug: "tehnician-dentar", nume: "Tehnician dentar", de: "tehnician dentar", categorie: "medical", caen3: "86", caen2: "Q", isco: "tehnicieni", cor: "325101",
    ceFace: "Realizează în laborator dispozitive protetice dentare, coroane, punți și aparate ortodontice pe baza amprentelor furnizate de medicul stomatolog." },
  ...
  { slug: "asistent-farmacie", nume: "Asistent de farmacie", de: "asistent de farmacie", categorie: "medical", caen3: "47", caen2: "G", isco: "tehnicieni", cor: "321301",
    ceFace: "Consiliază pacienții în alegerea produselor eliberate fără rețetă, recepționează comenzile de medicamente și gestionează stocurile farmaciei." },
  { slug: "farmacist-industrie", nume: "Farmacist în industrie", de: "farmacist în industrie", categorie: "medical", caen3: "21", caen2: "21", isco: "specialisti",
  ...
  { slug: "kinetoterapeut", nume: "Kinetoterapeut", de: "kinetoterapeut", categorie: "medical", caen3: "86", caen2: "Q", isco: "specialisti", cor: "226401",
    ceFace: "Elaborează și aplică programe personalizate de kinetoterapie și gimnastică medicală pentru recuperarea funcțională neuromotorie și ortopedică a pacienților." },
  ...
  { slug: "medic-veterinar", nume: "Medic veterinar", de: "medic veterinar", categorie: "medical", caen3: "75", caen2: "M", isco: "specialisti", cor: "225002",
  ...
  { slug: "profesor-universitar", nume: "Profesor universitar", de: "profesor universitar", categorie: "educatie", caen3: "Q", caen2: "P", isco: "specialisti", cor: "231005",
    ceFace: "Predă și coordonează cercetare într-o universitate, pe o poziție obținută prin concurs." },
  { slug: "cercetator", nume: "Cercetător", de: "cercetător", categorie: "educatie", caen3: "72", caen2: "72", isco: "specialisti",
    ceFace: "Lucrează în proiecte de cercetare-dezvoltare, în institute publice sau în departamente de R&D private." },
  { slug: "instructor-auto", nume: "Instructor auto", de: "instructor auto", categorie: "educatie", caen3: "Q", caen2: "P", isco: "servicii", cor: "516502",
    ceFace: "Pregătește candidații pentru permisul de conducere, în școli de șoferi autorizate." },

  // ─── Finanțe, bănci și asigurări ───────────────────────────────────────────
  { slug: "contabil", nume: "Contabil", de: "contabil", categorie: "finante", caen3: "69", caen2: "M", isco: "tehnicieni", cor: "331302",
    ceFace: "Ține evidența contabilă, întocmește declarațiile fiscale și pregătește situațiile financiare." },
  { slug: "auditor", nume: "Auditor financiar", de: "auditor financiar", categorie: "finante", caen3: "69", caen2: "M", isco: "specialisti", cor: "241107",
    ceFace: "Verifică independent situațiile financiare ale unei entități și emite o opinie de audit." },
  { slug: "analist-financiar", nume: "Analist financiar", de: "analist financiar", categorie: "finante", caen3: "64", caen2: "64", isco: "specialisti", cor: "241305",
    ceFace: "Analizează performanța financiară, construiește modele și fundamentează decizii de investiție sau creditare." },
  { slug: "economist", nume: "Economist", de: "economist", categorie: "finante", caen3: "69", caen2: "M", isco: "specialisti", cor: "263102",
    ceFace: "Analizează date economice, întocmește bugete și fundamentează deciziile financiare ale unei organizații." },
  { slug: "ofiter-credite", nume: "Ofițer de credite", de: "ofițer de credite", categorie: "finante", caen3: "64", caen2: "64", isco: "specialisti", cor: "241230",
    ceFace: "Analizează dosarele de credit ale clienților unei bănci și urmărește portofoliul acordat." },
  { slug: "agent-asigurari", nume: "Agent de asigurări", de: "agent de asigurări", categorie: "finante", caen3: "65", caen2: "65", isco: "tehnicieni", cor: "332101",
    ceFace: "Vinde polițe de asigurare și asistă clienții la constatarea și dosarul de daună." },
  { slug: "broker", nume: "Broker", de: "broker", categorie: "finante", caen3: "66", caen2: "66", isco: "tehnicieni",
    ceFace: "Intermediază tranzacții financiare sau polițe în numele clienților, contra unui comision." },
  { slug: "consultant-financiar", nume: "Consultant financiar", de: "consultant financiar", categorie: "finante", caen3: "66", caen2: "66", isco: "specialisti",
    ceFace: "Consiliază persoane sau firme pe economisire, investiții, finanțare și structuri fiscale." },

  // ─── Juridic ───────────────────────────────────────────────────────────────
  { slug: "avocat", nume: "Avocat", de: "avocat", categorie: "juridic", caen3: "69", caen2: "M", isco: "specialisti", cor: "261101",
  ...
  { slug: "notar", nume: "Notar", de: "notar", categorie: "juridic", caen3: "69", caen2: "M", isco: "specialisti", cor: "261906",
  ...
  { slug: "judecator", nume: "Judecător", de: "judecător", categorie: "juridic", caen3: "P", caen2: "O", isco: "specialisti", cor: "261202",
  ...
  { slug: "procuror", nume: "Procuror", de: "procuror", categorie: "juridic", caen3: "P", caen2: "O", isco: "specialisti", cor: "261201",
  ...
  { slug: "grefier", nume: "Grefier", de: "grefier", categorie: "juridic", caen3: "P", caen2: "O", isco: "tehnicieni", cor: "343102",
    ceFace: "Întocmește actele de procedură, consemnează ședințele de judecată și ține evidența dosarelor unei instanțe.",
    nota: "Personal auxiliar de specialitate al instanțelor, plătit din fonduri publice. Media sectorului acoperă toată administrația publică și apărarea, deci nu descrie salariul unui grefier." },

  // ─── Inginerie și arhitectură ──────────────────────────────────────────────
  { slug: "inginer", nume: "Inginer", de: "inginer", categorie: "inginerie", caen3: "71", caen2: "M", isco: "specialisti",
  ...
  { slug: "inginer-electronist", nume: "Inginer electronist", de: "inginer electronist", categorie: "inginerie", caen3: "26", caen2: "26", isco: "specialisti", cor: "215213",
    ceFace: "Proiectează și testează circuite și echipamente electronice, de la plăci la sisteme complete." },
  { slug: "inginer-auto", nume: "Inginer auto", de: "inginer auto", categorie: "inginerie", caen3: "29", caen2: "29", isco: "specialisti", cor: "214412",
    ceFace: "Lucrează la proiectarea, testarea sau industrializarea componentelor și vehiculelor." },
  { slug: "inginer-energetician", nume: "Inginer energetician", de: "inginer energetician", categorie: "inginerie", caen3: "D", caen2: "D", isco: "specialisti", cor: "215108",
    ceFace: "Se ocupă de producția, transportul și distribuția energiei electrice și termice." },
  { slug: "inginer-petrol", nume: "Inginer petrolist", de: "inginer petrolist", categorie: "inginerie", caen3: "06", caen2: "06", isco: "specialisti", cor: "214616",
  ...
  // ─── Construcții ───────────────────────────────────────────────────────────
  { slug: "constructor", nume: "Muncitor în construcții", de: "muncitor în construcții", categorie: "constructii", caen3: "41", caen2: "F", isco: "muncitori",
    ceFace: "Execută lucrări de structură și finisaje pe șantiere de clădiri rezidențiale sau industriale." },
  { slug: "zidar", nume: "Zidar", de: "zidar", categorie: "constructii", caen3: "41", caen2: "F", isco: "muncitori", cor: "711205",
  ...
  { slug: "instalator", nume: "Instalator", de: "instalator", categorie: "constructii", caen3: "43", caen2: "F", isco: "muncitori", cor: "712609",
    ceFace: "Execută instalații sanitare, de încălzire și de gaze și intervine la avarii." },
  { slug: "zugrav", nume: "Zugrav", de: "zugrav", categorie: "constructii", caen3: "43", caen2: "F", isco: "muncitori", cor: "713102",
  ...
  { slug: "operator-productie", nume: "Operator producție", de: "operator producție", categorie: "industrie", caen3: "C", caen2: "C", isco: "operatori",
  ...
  { slug: "tehnician-mentenanta", nume: "Tehnician mentenanță", de: "tehnician mentenanță", categorie: "industrie", caen3: "33", caen2: "33", isco: "tehnicieni",
    ceFace: "Face mentenanța preventivă și intervențiile la utilajele dintr-o fabrică." },
  { slug: "metalurgist", nume: "Metalurgist", de: "metalurgist", categorie: "industrie", caen3: "24", caen2: "24", isco: "operatori",
  ...
  { slug: "croitor", nume: "Croitor", de: "croitor", categorie: "industrie", caen3: "14", caen2: "14", isco: "muncitori", cor: "753101",
    ceFace: "Croiește și coase articole de îmbrăcăminte, în producție de serie sau la comandă." },
  { slug: "muncitor-industria-alimentara", nume: "Muncitor în industria alimentară", de: "muncitor în industria alimentară", categorie: "industrie", caen3: "10", caen2: "10", isco: "operatori",
    ceFace: "Lucrează pe fluxul de procesare, ambalare și control al produselor alimentare." },
  { slug: "cofetar", nume: "Cofetar", de: "cofetar", categorie: "industrie", caen3: "10", caen2: "10", isco: "muncitori", cor: "751202",
  ...
  { slug: "mecanic-locomotiva", nume: "Mecanic de locomotivă", de: "mecanic de locomotivă", categorie: "transport", caen3: "49", caen2: "49", isco: "operatori", cor: "831101",
    ceFace: "Conduce trenuri de marfă sau de călători și răspunde de siguranța circulației." },
  { slug: "curier", nume: "Curier", de: "curier", categorie: "transport", caen3: "53", caen2: "53", isco: "elementare", cor: "962101",
    ceFace: "Livrează colete pe o rută zilnică și gestionează ramburs, retururi și confirmări." },
  { slug: "sofer-ridesharing", nume: "Șofer ridesharing", de: "șofer de ridesharing", categorie: "transport", caen3: "49", caen2: "49", isco: "operatori", cor: "832201",
    ceFace: "Transportă pasageri prin platforme de tip Bolt sau Uber, de regulă ca PFA sau prin firmă parteneră.",
    nota: "Venitul depinde de cursele efectuate și de comisionul platformei; nu este salariu la normă întreagă." },
  { slug: "postas", nume: "Poștaș", de: "poștaș", categorie: "transport", caen3: "53", caen2: "53", isco: "functionari", cor: "441206",
    ceFace: "Distribuie corespondența și pensiile pe un sector și încasează plăți la domiciliu." },
  { slug: "pilot", nume: "Pilot", de: "pilot", categorie: "transport", caen3: "51", caen2: "51", isco: "specialisti",
    ceFace: "Operează aeronave comerciale pe rute programate, cu licență și verificări periodice." },
  { slug: "insotitor-de-bord", nume: "Însoțitor de bord (stewardesă)", de: "însoțitor de bord (stewardesă)", categorie: "transport", caen3: "51", caen2: "51", isco: "servicii", cor: "511101",
    ceFace: "Asigură securitatea zborului, procedurile de urgență și serviciul la bordul aeronavei (rol cunoscut uzual drept stewardesă sau steward)." },
  { slug: "sofer-ambulanta", nume: "Șofer de ambulanță", de: "șofer de ambulanță", categorie: "transport", caen3: "86", caen2: "Q", isco: "operatori", cor: "832203",
  ...
  { slug: "casier", nume: "Casier", de: "casier", categorie: "comert", caen3: "47", caen2: "G", isco: "servicii", cor: "523003",
    ceFace: "Operează casa de marcat, gestionează numerarul și emite bonurile fiscale." },
  { slug: "manager-magazin", nume: "Manager de magazin", de: "manager de magazin", categorie: "comert", caen3: "47", caen2: "G", isco: "conducatori",
  ...
  { slug: "receptioner-hotel", nume: "Recepționer hotel", de: "recepționer de hotel", categorie: "horeca", caen3: "55", caen2: "I", isco: "functionari", cor: "422401",
    ceFace: "Face check-in și check-out, rezervări și facturare și rezolvă solicitările oaspeților." },
  { slug: "agent-turism", nume: "Agent de turism", de: "agent de turism", categorie: "horeca", caen3: "79", caen2: "N", isco: "functionari", cor: "422101",
  ...
  { slug: "jandarm", nume: "Jandarm", de: "jandarm", categorie: "public", caen3: "P", caen2: "O", isco: "servicii", cor: "541101",
    ...
    nota: "Cadru militar în Jandarmeria Română, salarizat pe aceeași anexă ca armata." },
  { slug: "pompier", nume: "Pompier", de: "pompier", categorie: "public", caen3: "P", caen2: "O", isco: "servicii",
    ceFace: "Intervine la incendii, accidente și situații de urgență, în ture de serviciu." },
  { slug: "militar", nume: "Militar", de: "militar", categorie: "public", caen3: "P", caen2: "O", isco: "servicii",
    ceFace: "Servește într-o structură a apărării, pe o funcție de soldat, subofițer sau ofițer." },

  // ─── Media, creație și marketing ───────────────────────────────────────────
  { slug: "jurnalist", nume: "Jurnalist", de: "jurnalist", categorie: "media", caen3: "60", caen2: "59-60", isco: "specialisti",
    ceFace: "Documentează, verifică și publică materiale de presă, pentru televiziune, radio sau online." },
  { slug: "editor", nume: "Editor", de: "editor", categorie: "media", caen3: "58", caen2: "58", isco: "specialisti", cor: "264211",
    ceFace: "Selectează, corectează și pregătește pentru publicare textele dintr-o redacție sau editură." },
  { slug: "cameraman", nume: "Cameraman", de: "cameraman", categorie: "media", caen3: "59", caen2: "59-60", isco: "tehnicieni", cor: "352131",
    ceFace: "Filmează pentru producții TV, film sau conținut online și răspunde de imagine și lumină." },
  { slug: "regizor", nume: "Regizor", de: "regizor", categorie: "media", caen3: "59", caen2: "59-60", isco: "specialisti", cor: "265410",
  ...
  { slug: "specialist-marketing", nume: "Specialist marketing", de: "specialist marketing", categorie: "media", caen3: "73", caen2: "M", isco: "specialisti", cor: "243103",
    ceFace: "Planifică și măsoară campanii, conținut și canale, cu buget și obiective de conversie." },
  { slug: "traducator", nume: "Traducător", de: "traducător", categorie: "media", caen3: "74", caen2: "M", isco: "specialisti", cor: "264306",
  ...
  { slug: "muzician", nume: "Muzician", de: "muzician", categorie: "media", caen3: "90", caen2: "R", isco: "specialisti",
    ceFace: "Interpretează sau compune muzică, în ansambluri, orchestre sau proiecte proprii." },

  // ─── Agricultură și silvicultură ───────────────────────────────────────────
  { slug: "fermier", nume: "Fermier", de: "fermier", categorie: "agricultura", caen3: "01", caen2: "01", isco: "agricultura", cor: "613001",
    ceFace: "Administrează o exploatație agricolă: culturi, animale, utilaje și subvenții." },
  { slug: "silvicultor", nume: "Silvicultor", de: "silvicultor", categorie: "agricultura", caen3: "02", caen2: "02-03", isco: "specialisti", cor: "213234",
    ceFace: "Gestionează fondul forestier: regenerare, marcare, pază și exploatare." },

  // ─── Utilități și mediu ────────────────────────────────────────────────────
  { slug: "electrician-centrala", nume: "Electrician centrală electrică", de: "electrician de centrală electrică", categorie: "utilitati", caen3: "D", caen2: "D", isco: "muncitori", cor: "741301",
    ceFace: "Operează și întreține echipamentele dintr-o centrală de producție sau o stație de transformare." },
  { slug: "operator-statie-apa", nume: "Operator stație de apă", de: "operator de stație de apă", categorie: "utilitati", caen3: "36", caen2: "36", isco: "tehnicieni", cor: "313202",
  ...
  { slug: "operator-call-center", nume: "Operator call center", de: "operator de call center", categorie: "servicii", caen3: "82", caen2: "N", isco: "functionari",
  ...
  { slug: "administrator-bloc", nume: "Administrator de bloc", de: "administrator de bloc", categorie: "servicii", caen3: "N", caen2: "N", isco: "tehnicieni", cor: "515102",
    ceFace: "Ține contabilitatea asociației de proprietari, repartizează cheltuielile și organizează întreținerea clădirii." },
  { slug: "frizer", nume: "Frizer", de: "frizer", categorie: "servicii", caen3: "96", caen2: "S", isco: "servicii", cor: "514102",
  ...
  { slug: "bibliotecar", nume: "Bibliotecar", de: "bibliotecar", categorie: "servicii", caen3: "91", caen2: "R", isco: "specialisti", cor: "262202",
    ceFace: "Organizează colecțiile și accesul publicului într-o bibliotecă sau într-un centru de documentare." },
  { slug: "antrenor-sportiv", nume: "Antrenor sportiv", de: "antrenor sportiv", categorie: "servicii", caen3: "93", caen2: "R", isco: "tehnicieni", cor: "342201",
    ceFace: "Pregătește sportivi sau grupe de amatori și planifică antrenamentele și competițiile." },
  { slug: "preot", nume: "Preot", de: "preot", categorie: "servicii", caen3: "94", caen2: "S", isco: "specialisti", cor: "263627",
  ...
  { slug: "ingrijitor-batrani", nume: "Îngrijitor de bătrâni", de: "îngrijitor de bătrâni", categorie: "servicii", caen3: "87", caen2: "Q", isco: "servicii", cor: "532201",
    ceFace: "Asigură îngrijirea la domiciliu sau în centre rezidențiale pentru persoane vârstnice: igienă, hrană, administrarea medicației și confortul zilnic." },
  ...
  { slug: "asistent-social", nume: "Asistent social", de: "asistent social", categorie: "medical", caen3: "88", caen2: "Q", isco: "specialisti", cor: "263501",
  ...
  { slug: "operator-cnc", nume: "Operator CNC", de: "operator CNC", categorie: "industrie", caen3: "28", caen2: "28", isco: "muncitori", cor: "722323",
    ceFace: "Programează și supraveghează mașini-unelte cu comandă numerică, verificând cotele pieselor rezultate." },
  { slug: "electromecanic", nume: "Electromecanic", de: "electromecanic", categorie: "industrie", caen3: "27", caen2: "27", isco: "muncitori", cor: "742214",
  ...
  { slug: "operator-mase-plastice", nume: "Operator mase plastice", de: "operator mase plastice", categorie: "industrie", caen3: "22", caen2: "22", isco: "operatori", cor: "814209",
  ...
  { slug: "sondor", nume: "Sondor", de: "sondor", categorie: "industrie", caen3: "09", caen2: "09", isco: "operatori", cor: "811310",
  ...
  { slug: "tesator", nume: "Țesător", de: "țesător", categorie: "industrie", caen3: "13", caen2: "13", isco: "muncitori", cor: "731816",
    ceFace: "Deservește războaie de țesut și mașini de filat și verifică defectele de material." },
  { slug: "cizmar", nume: "Cizmar", de: "cizmar", categorie: "industrie", caen3: "15", caen2: "15", isco: "muncitori", cor: "753601",
    ceFace: "Confecționează și repară încălțăminte și articole din piele, în atelier propriu sau în producție." },
  { slug: "tapiter", nume: "Tapițer", de: "tapițer", categorie: "industrie", caen3: "31", caen2: "31", isco: "muncitori", cor: "753401",
    ceFace: "Îmbracă și recondiționează mobilierul: croiește materialul, montează arcurile și spuma, finisează cusăturile." },
  { slug: "bijutier", nume: "Bijutier", de: "bijutier", categorie: "servicii", caen3: "32", caen2: "32", isco: "muncitori", cor: "731302",
    ceFace: "Execută și repară bijuterii din metale prețioase, de la modelare și lipire până la montarea pietrelor." },
  { slug: "tipograf", nume: "Tipograf", de: "tipograf", categorie: "media", caen3: "18", caen2: "18", isco: "muncitori", cor: "732207",
  ...
  { slug: "marinar", nume: "Marinar", de: "marinar", categorie: "transport", caen3: "50", caen2: "50", isco: "operatori", cor: "835001",
    ceFace: "Face parte din echipajul unei nave de transport fluvial sau maritim și răspunde de manevre, punte și încărcătură." },
  { slug: "inginer-aeronautic", nume: "Inginer aeronautic", de: "inginer aeronautic", categorie: "inginerie", caen3: "30", caen2: "30", isco: "specialisti", cor: "214437",
  ...
  { slug: "operator-epurare", nume: "Operator stație de epurare", de: "operator de stație de epurare", categorie: "utilitati", caen3: "37", caen2: "37", isco: "operatori", cor: "818902",
    ceFace: "Conduce treptele de epurare a apelor uzate și urmărește indicatorii de calitate la evacuare." },
  { slug: "crupier", nume: "Crupier", de: "crupier", categorie: "servicii", caen3: "92", caen2: "R", isco: "functionari", cor: "421201",
    ceFace: "Conduce jocurile la masă într-un cazinou, plătește câștigurile și veghează la respectarea regulilor." },
  { slug: "tehnician-calculatoare", nume: "Tehnician service IT", de: "tehnician service IT", categorie: "it", caen3: "95", caen2: "S", isco: "tehnicieni", cor: "351103",
    ceFace: "Diagnostichează și repară calculatoare, laptopuri și periferice, într-un service independent sau de rețea." },
  { slug: "consultant-management", nume: "Consultant în management", de: "consultant în management", categorie: "servicii", caen3: "70", caen2: "M", isco: "specialisti", cor: "263107",
  ...
  { slug: "pescar", nume: "Pescar", de: "pescar", categorie: "agricultura", caen3: "03", caen2: "02-03", isco: "agricultura", cor: "622201",
