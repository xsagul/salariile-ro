        ...
        <section className="section-surface">
          <div className="container">
            <div className="grid-auto">
              ...
              {/* S2 */}
              <article className="card">
                <div className="eyebrow">1 Iulie – 31 Decembrie 2026</div>
                <div className="stat-rows">
                  <StatRow label="Salariu brut" value={`${fmt(4325)} lei`} lg />
                  <StatRow label="Salariu net" value={`${fmt(2699)} lei`} xl accent bold />
                  <div className="stat-divider" />
                  <StatRow label="Cost angajator" value={`${fmt(4418)} lei`} sm />
                  <StatRow label="Facilitate fiscală" value="200 lei netaxabili" sm accent bold />
                  <StatRow label="Tarif orar" value="25,949 lei/oră" sm />
                </div>
                <Link href="/calculator/calcul-salariu-net-4325-brut" className="chip">Calculează detaliat 4.325 lei →</Link>
              </article>
            </div>
