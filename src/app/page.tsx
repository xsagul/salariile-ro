...
const homepageJsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "FAQPage",
      // 2. Generăm schema pentru Google automat din datele noastre
...
export default function Page() {
  return (
    <>
      ...
      {/* 3. Afișăm secțiunea pentru vizitatori la finalul paginii */}
        ...
        <div className="container" style={{ maxWidth: "860px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
            {faqData.map((faq, index) => (
              <details key={index} style={{ borderBottom: "1px solid var(--border)", padding: "0.875rem 0" }}>
                <summary 
                  style={{ 
                    fontSize: "0.9375rem", 
                    fontWeight: 500, 
                ...
                <p style={{ marginTop: "0.75rem", color: "var(--muted)", fontSize: "0.9375rem", lineHeight: 1.7 }}>
                  {faq.a}
                </p>
              </details>
            ))}
