...
const PROSE = [
  ...
  "[&_table]:my-6 [&_table]:w-full [&_table]:overflow-hidden [&_table]:rounded-md [&_table]:border [&_table]:border-stone-300 [&_table]:bg-surface [&_table]:shadow-soft [&_table]:border-separate [&_table]:border-spacing-0 [&_table]:text-left [&_table]:text-sm [&_table]:tabular-nums [&_table]:text-stone-700",
  ...
  "[&_thead_th]:border-b [&_thead_th]:border-stone-300 [&_thead_th]:bg-antet [&_thead_th]:px-3 [&_thead_th]:py-3 [&_thead_th]:text-xs [&_thead_th]:font-medium [&_thead_th]:uppercase [&_thead_th]:tracking-wide [&_thead_th]:text-stone-600",
