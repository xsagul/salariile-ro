...
import { Breadcrumb, GrilaPagina, H1, Lead, SPATIU_JOS, SPATIU_SUS, INAINTE_DE_SECTIUNE } from '@/app/components/ui';
...
export default function Calendar2027({tip}:{tip:'libere'|'lucratoare'}){
 ...
 return <div className="bg-canvas"><div className={`mx-auto max-w-6xl px-4 sm:px-6 ${SPATIU_SUS} ${SPATIU_JOS}`}><GrilaPagina continut={<>
