...
// Footer global. Rămâne Server Component; doar butonul de preferințe Google
...
const IMPLEMENTED_PAGES = new Set<string>([
  ...
  "/calculator-salariu-constructii",
...
// Subsolul apare pe fiecare pagină: fiecare link de aici primește o parte din
...
const FOOTER_GROUPS: Array<{ title: string; links: FooterLink[] }> = [
  {
    ...
    links: [
      ...
      { href: "/calculator-salariu-part-time", label: "Calculator salariu part-time" },
      { href: "/calculator-pfa", label: "Calculator PFA" },
      { href: "/fluturas-salariu", label: "Generator fluturaș salariu" },
      { href: "/calculator-salariu-constructii", label: "Calculator salariu construcții" },
                ...
                {group.links.map((link) =>
                  link.external ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener"
                      className="-mx-2 flex min-h-11 items-center rounded px-2 text-sm text-stone-600 hover:bg-stone-100 hover:text-stone-900"
                    >
                      {link.label}
                    </a>
                  ) : (
        ...
        <div className="flex flex-col flex-wrap items-center justify-between gap-4 text-center sm:flex-row sm:text-left">
          ...
          <div className="inline-flex items-center gap-2" role="group" aria-label="Profiluri publice autor">
            <a
              ...
              title="LinkedIn"
              className="inline-flex h-11 w-11 items-center justify-center rounded-md text-stone-600 transition-colors hover:bg-stone-200 hover:text-stone-900 focus-visible:bg-stone-200 focus-visible:text-stone-900"
            >
              ...
              <span className="sr-only">Profilul LinkedIn al autorului</span>
            </a>
            <a
            ...
            >
              ...
              <span className="sr-only">Profilul GitHub al autorului</span>
            </a>
          </div>
        </div>
      </div>
