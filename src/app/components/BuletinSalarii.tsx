...
export default function BuletinSalarii(){
 ...
 return <section id="buletin-lunar" className="space-y-4">
  <h2 className={`!mt-0 ${TITLU_SECTIUNE}`}>Buletin salarial · {lunaLunga(LUNI_SERIE[i])}</h2>
