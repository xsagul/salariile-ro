...
export default function BuletinSalarii(){
 ...
 return <section id="buletin-lunar" className="mt-10 space-y-4">
  ...
  <nav className="flex flex-wrap gap-4 text-sm"><a download className="min-h-11 py-3 underline" href="/api/date-salarii/serie?format=csv">Descarcă seria CSV</a><a download className="min-h-11 py-3 underline" href="/api/date-salarii/serie?format=json">Descarcă seria JSON</a><Link className="min-h-11 py-3 underline" href="/salarii/judete">Comparație între județe</Link></nav>
