...
- GSC este conectat. **Măsurarea de bază rămâne Cloudflare Web Analytics, din 12 septembrie 2026** — fără cookies, fără localStorage și fără amprentare. Din 17 septembrie 2026 rulează și **Google Analytics 4 (`G-2L1J64H5H9`) numai după consimțământ explicit**: înainte de „Da” nu se descarcă scriptul și nu pleacă pinguri; semnalele publicitare sunt dezactivate, iar „Nu” este disponibil la același nivel. Alegerea se reține șase luni și se poate schimba din subsol. Rutele `/widget/frame*` nu primesc nici Cloudflare Web Analytics, nici GA4. GA4 are măsurarea îmbunătățită standard, nu evenimente proprii de calculator, deci întrebarea „câte sesiuni includ un calcul salarial” rămâne încă fără răspuns. Umami a fost dezafectat pe 28 august 2026; Vercel Analytics și Speed Insights au dispărut odată cu Vercel. Core Web Vitals din teren se iau din CrUX (`npm run psi`) și se compară cu `docs/arhiva/CWV-INAINTE-DE-CLOUDFLARE-2026-09-12.json`.
